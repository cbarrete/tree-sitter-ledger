...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [54] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(31),
  ...
  [108] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_plain_xact_repeat1, 2), SHIFT_REPEAT(45),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_plain_xact, 5),
  [113] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_plain_xact, 5),
  ...
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_plain_xact, 7),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_plain_xact, 7),
  ...
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quantity, 1),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_quantity, 1),
  ...
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_word_directive, 1),
  [209] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_word_directive, 1),
  ...
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_price, 2),
