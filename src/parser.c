...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(aux_sym_commodity_token1_character_set_1, 677, lookahead)) ADVANCE(723);
      END_STATE();
    case 1:
      ADVANCE_MAP(
        '\t', 739,
    ...
    case 3:
      ...
      if (set_contains(aux_sym_tag_directive_token1_character_set_2, 771, lookahead)) ADVANCE(62);
      END_STATE();
    case 4:
      if (lookahead == '\t') ADVANCE(739);
      if (lookahead == ' ') ADVANCE(733);
    ...
    case 6:
      ...
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(61);
      if (set_contains(aux_sym_tag_directive_token1_character_set_1, 770, lookahead)) ADVANCE(62);
      END_STATE();
    case 7:
      if (lookahead == '\t') ADVANCE(739);
      if (lookahead == ' ') ADVANCE(733);
